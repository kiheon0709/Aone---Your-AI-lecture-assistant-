    ...
    return (
      <div className="h-full flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">전체 요약을 생성하고 있습니다...</p>
      ...
      <div className="bg-white border-b border-gray-200 p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-800">전체 요약</h2>
              <p className="text-sm text-gray-600">AI가 생성한 문서 전체 요약</p>
            </div>
          </div>
          <button
            onClick={handleGenerateSummary}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <div className="prose max-w-none">
            ...
            <div className="flex items-center gap-2 my-4">
              <button className="px-3 py-1 bg-blue-50 text-blue-700 rounded-md text-sm font-medium hover:bg-blue-100 transition-colors inline-flex items-center gap-1">
                Slide 3
